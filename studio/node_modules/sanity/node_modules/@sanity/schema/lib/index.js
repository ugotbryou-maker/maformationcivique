...
var __defProp$8 = Object.defineProperty, __getOwnPropSymbols$8 = Object.getOwnPropertySymbols, __hasOwnProp$8 = Object.prototype.hasOwnProperty, __propIsEnum$8 = Object.prototype.propertyIsEnumerable, __defNormalProp$8 = (obj, key, value) => key in obj ? __defProp$8(obj, key, { enumerable: !0, configurable: !0, writable: !0, value }) : obj[key] = value, __spreadValues$7 = (a, b) => {
  for (var prop in b || (b = {}))
...
function guessPreviewFields(rawObjectTypeDef) {
  const objectTypeDef = __spreadValues$7({ fields: [] }, rawObjectTypeDef), stringFieldNames = objectTypeDef.fields.filter((field) => field.type === "string").map((field) => field.name), blockFieldNames = objectTypeDef.fields.filter(isBlockField).map((field) => field.name);
...
function parsePreview(preview) {
  ...
  return Array.isArray(select) ? __spreadProps$4(__spreadValues$6({}, pick__default.default(preview, ["prepare", "component"])), {
    select: parseSelection(select)
  }) : __spreadProps$4(__spreadValues$6({}, pick__default.default(preview, ["prepare", "component"])), {
    select
  });
}
...
const INHERITED_FIELDS$1 = [
  ...
  extend(subTypeDef, extendMember) {
    const options = __spreadValues$5({}, subTypeDef.options || DEFAULT_OPTIONS$3), _a = subTypeDef, { marks, styles, lists, of } = _a, rest = __objRest$6(_a, ["marks", "styles", "lists", "of"]), childrenField = createChildrenField(marks, of), styleField = createStyleField(styles), listItemField = createListItemField(lists), markDefsField = {
      name: "markDefs",
    ...
    return lazyGetter(parsed, "fields", () => fields.map((fieldDef) => {
      const _a2 = fieldDef, { name } = _a2, type = __objRest$6(_a2, ["name"]);
      return {
        name,
...
const INHERITED_FIELDS = [
  ...
  extend(subTypeDef, extendMember) {
    const options = __spreadValues$4({}, subTypeDef.options || DEFAULT_OPTIONS$2), { annotations = [], marks = [] } = subTypeDef, fields = [MARKS_FIELD, TEXT_FIELD], parsed = Object.assign(pick__default.default(SPAN_CORE, INHERITED_FIELDS), subTypeDef, {
      type: SPAN_CORE,
      options
    });
    return lazyGetter(parsed, "fields", () => fields.map((fieldDef) => {
      const _a = fieldDef, { name } = _a, type = __objRest$5(_a, ["name"]);
      return {
        name,
        type: extendMember(type)
      };
...
const CrossDatasetReferenceType = {
  ...
  extend(subTypeDef, createMemberType) {
    ...
    return lazyGetter(parsed, "fields", () => REFERENCE_FIELDS$1.map((fieldDef) => {
      const _a = fieldDef, { name } = _a, type = __objRest$4(_a, ["name"]);
      return {
        name,
        type: createMemberType(type)
      };
    })), lazyGetter(parsed, "to", () => arrify__default.default(subTypeDef.to).map((toType) => __spreadProps$3(__spreadValues$3({}, toType), {
...
const OVERRIDABLE_FIELDS$8 = [
  ...
  extend(rawSubTypeDef, createMemberType) {
    const subTypeDef = __spreadValues$2({ fields: [] }, rawSubTypeDef), options = __spreadValues$2({}, subTypeDef.options || {}), parsed = Object.assign(pick__default.default(this.get(), OVERRIDABLE_FIELDS$8), subTypeDef, {
      type: this.get(),
      ...
      fields: subTypeDef.fields.map((fieldDef) => {
        const _a = fieldDef, { name, fieldset, group } = _a, rest = __objRest$3(_a, ["name", "fieldset", "group"]);
        return lazyGetter({
          name,
          group,
          fieldset
...
function createFieldsets(typeDef, fields) {
  ...
  for (const fieldset of typeDef.fieldsets || []) {
    ...
    fieldsetsByName[fieldset.name] = __spreadProps$2(__spreadValues$2({ title: startCase__default.default(fieldset.name) }, fieldset), { fields: [] });
  }
...
function createFieldsGroups(typeDef, fields) {
  ...
  for (const group of typeDef.groups || []) {
    ...
    if (groupsByName[group.name] = __spreadProps$2(__spreadValues$2({ title: startCase__default.default(group.name) }, group), { fields: [] }), group.default && ++numDefaultGroups > 1)
      throw new Error(
...
const ASSET_FIELD$1 = {
  ...
  extend(rawSubTypeDef, createMemberType) {
    const options = __spreadValues$1({}, rawSubTypeDef.options || DEFAULT_OPTIONS$1), fields = [ASSET_FIELD$1, ...rawSubTypeDef.fields || []], subTypeDef = __spreadProps$1(__spreadValues$1({}, rawSubTypeDef), { fields }), parsed = Object.assign(pick__default.default(FILE_CORE, OVERRIDABLE_FIELDS$6), subTypeDef, {
      type: FILE_CORE,
      title: subTypeDef.title || (subTypeDef.name ? startCase__default.default(subTypeDef.name) : FILE_CORE.title),
      options,
      fields: subTypeDef.fields.map((fieldDef) => {
        const _a = fieldDef, { name, fieldset } = _a, rest = __objRest$2(_a, ["name", "fieldset"]), compiledField = {
          name,
          fieldset,
...
var __defProp$1 = Object.defineProperty, __defProps = Object.defineProperties, __getOwnPropDescs = Object.getOwnPropertyDescriptors, __getOwnPropSymbols$1 = Object.getOwnPropertySymbols, __hasOwnProp$1 = Object.prototype.hasOwnProperty, __propIsEnum$1 = Object.prototype.propertyIsEnumerable, __defNormalProp$1 = (obj, key, value) => key in obj ? __defProp$1(obj, key, { enumerable: !0, configurable: !0, writable: !0, value }) : obj[key] = value, __spreadValues = (a, b) => {
  for (var prop in b || (b = {}))
...
const OVERRIDABLE_FIELDS$5 = [...DEFAULT_OVERRIDEABLE_FIELDS], IMAGE_CORE = {
  name: "image",
  title: "Image",
  type: null,
  jsonType: "object"
  ...
  extend(rawSubTypeDef, createMemberType) {
    ...
    options.hotspot || (hotspotFields = hotspotFields.map((field) => __spreadProps(__spreadValues({}, field), { hidden: !0 })));
    const fields = [ASSET_FIELD, ...hotspotFields, ...rawSubTypeDef.fields || []], subTypeDef = __spreadProps(__spreadValues({}, rawSubTypeDef), { fields }), parsed = Object.assign(pick__default.default(this.get(), OVERRIDABLE_FIELDS$5), subTypeDef, {
      type: IMAGE_CORE,
      title: subTypeDef.title || (subTypeDef.name ? startCase__default.default(subTypeDef.name) : IMAGE_CORE.title),
      options,
      fields: subTypeDef.fields.map((fieldDef) => {
        const _a = fieldDef, { name, fieldset } = _a, rest = __objRest$1(_a, ["name", "fieldset"]), compiledField = {
          name,
          fieldset,
          isCustomized: !!rawSubTypeDef.fields
        };
...
const ReferenceType = {
  ...
  extend(subTypeDef, createMemberType) {
    ...
    return lazyGetter(parsed, "fields", () => REFERENCE_FIELDS.map((fieldDef) => {
      const _a = fieldDef, { name } = _a, type = __objRest(_a, ["name"]);
      return {
        name,
        type: createMemberType(type)
      };
