...
function extractSchema(schemaDef, extractOptions = {}) {
  ...
  function convertSchemaType(schemaType) {
    ...
    if (((_b = (_a = schemaType.type) == null ? void 0 : _a.type) == null ? void 0 : _b.name) === "object")
      return { type: "inline", name: schemaType.type.name };
    ...
    if (((_c = lastType(schemaType)) == null ? void 0 : _c.name) === "document") {
      ...
      return doc === void 0 ? { type: "unknown" } : { type: "object", attributes: doc == null ? void 0 : doc.attributes };
    }
...
var array = (typeDef, visitorContext) => {
  ...
  if (ofIsArray) {
    ...
    if (invalid.length > 0)
      return __spreadProps$a(__spreadValues$a({}, typeDef), {
        of: [],
        _problems: invalid
      });
  }
  ...
  ), __spreadProps$a(__spreadValues$a({}, typeDef), {
...
function validateBlockType(typeDef, visitorContext) {
  ...
  ), marks && (marks = validateMarks(typeDef.marks, visitorContext, problems)), styles && (styles = validateStyles(styles, visitorContext, problems)), lists && (lists = validateLists(lists, visitorContext, problems)), members && (members = validateMembers(members, visitorContext, problems)), __spreadProps$9(__spreadValues$9({}, omit__default.default(typeDef, disallowedKeys)), {
    marks,
    styles,
...
function validateMarks(marks, visitorContext, problems) {
  ...
  ) : annotations && (annotations = validateAnnotations(annotations, visitorContext, problems)), __spreadProps$9(__spreadValues$9({}, marks), { decorators, annotations });
}
...
function validateAnnotations(annotations, visitorContext, problems) {
  return annotations.map((annotation) => {
    ...
    if (!isPlainObject__default.default(annotation))
      return __spreadProps$9(__spreadValues$9({}, annotation), {
...
function validateMembers(members, visitorContext, problems) {
  ...
  return members.map((member) => {
    ...
    if (member.type === "object" && member.name && visitorContext.getType(member.name))
      return __spreadProps$9(__spreadValues$9({}, member), {
        _problems: [
          warning(
    ...
    return (
      ...
      }) : __spreadProps$9(__spreadValues$9({}, member), { _problems })
    );
  });
}
...
var crossDatasetReference = (typeDef, visitorContext) => {
  ...
  ), problems.push(...getOptionErrors$1(typeDef)), __spreadProps$7(__spreadValues$7({}, typeDef), {
    _problems: problems
  });
};
...
var object = (typeDef, visitorContext) => {
  ...
  ), __spreadProps$6(__spreadValues$6({}, typeDef), {
    preview,
    fields: (Array.isArray(typeDef.fields) ? typeDef.fields : []).map((field, index) => {
      const _a = field, { name } = _a, fieldTypeDef = __objRest$2(_a, ["name"]), _b = visitorContext.visit(fieldTypeDef, index), { _problems } = _b, fieldType = __objRest$2(_b, ["_problems"]);
  ...
  ) : invalidFieldNames.length > 0 && problems.push(error("The name `asset` is not a valid field name for type `file`.")), __spreadProps$5(__spreadValues$5({}, typeDef), {
    fields: (Array.isArray(fields) ? fields : []).map((field, index) => {
      const _a = field, { name } = _a, fieldTypeDef = __objRest$1(_a, ["name"]), _b = visitorContext.visit(fieldTypeDef, index), { _problems } = _b, fieldType = __objRest$1(_b, ["_problems"]);
...
var image = (typeDef, visitorContext) => {
  ...
  ), options = __spreadProps$4(__spreadValues$4({}, options), { metadata: metadata.filter((meta) => !autoMeta.includes(meta)) })) : fieldsWithInvalidName.length > 0 && problems.push(
    error(
      `The names \`${invalidFieldNames.join(
        "`, `"
      )}\` are invalid field names for type \`image\`.`
    )
  ), __spreadProps$4(__spreadValues$4({}, typeDef), {
    options,
    fields: (Array.isArray(fields) ? fields : []).map((field, index) => {
      const _a = field, { name } = _a, fieldTypeDef = __objRest(_a, ["name"]), _b = visitorContext.visit(fieldTypeDef, index), { _problems } = _b, fieldType = __objRest(_b, ["_problems"]);
...
var reference = (typeDef, visitorContext) => {
  ...
  ), problems.push(...getOptionErrors(typeDef)), __spreadProps$3(__spreadValues$3({}, typeDef), {
...
var __defProp$2 = Object.defineProperty, __defProps$2 = Object.defineProperties, __getOwnPropDescs$2 = Object.getOwnPropertyDescriptors, __getOwnPropSymbols$2 = Object.getOwnPropertySymbols, __hasOwnProp$2 = Object.prototype.hasOwnProperty, __propIsEnum$2 = Object.prototype.propertyIsEnumerable, __defNormalProp$2 = (obj, key, value) => key in obj ? __defProp$2(obj, key, { enumerable: !0, configurable: !0, writable: !0, value }) : obj[key] = value, __spreadValues$2 = (a, b) => {
  ...
  if (!hasName && Object.keys(typeDef).length === 1)
    return __spreadProps$2(__spreadValues$2({}, typeDef), {
      _problems: [
        error(
  ...
  ), problems.push(...validateComponent(typeDef)), "title" in typeDef && typeof typeDef.title != "string" && problems.push(warning("Type title is not a string.", HELP_IDS.TYPE_TITLE_INVALID)), __spreadProps$2(__spreadValues$2({}, typeDef), {
    _problems: problems
  });
};
...
var __defProp$1 = Object.defineProperty, __defProps$1 = Object.defineProperties, __getOwnPropDescs$1 = Object.getOwnPropertyDescriptors, __getOwnPropSymbols$1 = Object.getOwnPropertySymbols, __hasOwnProp$1 = Object.prototype.hasOwnProperty, __propIsEnum$1 = Object.prototype.propertyIsEnumerable, __defNormalProp$1 = (obj, key, value) => key in obj ? __defProp$1(obj, key, { enumerable: !0, configurable: !0, writable: !0, value }) : obj[key] = value, __spreadValues$1 = (a, b) => {
  ...
  ), typeDef.options.slugify = typeDef.options.slugifyFn), __spreadProps$1(__spreadValues$1({}, typeDef), {
    _problems: problems
  });
...
function combine(...visitors) {
  return (schemaType, visitorContext) => visitors.reduce(
    ...
    __spreadValues({ _problems: [] }, schemaType)
  );
}
