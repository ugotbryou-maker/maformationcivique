...
async function getOrCreateUserApplication({
  ...
  if (userApplications != null && userApplications.length) {
  ...
  return await prompt.single({
    ...
    validate: async (appHost) => {
      ...
      try {
        ...
        if ([402, 409].includes(e == null ? void 0 : e.statusCode))
          return ((_b = (_a = e == null ? void 0 : e.response) == null ? void 0 : _a.body) == null ? void 0 : _b.message) || "Bad request";
...
async function getOrCreateUserApplicationFromConfig({
  ...
  try {
    ...
    throw spinner.fail(), [402, 409].includes(e == null ? void 0 : e.statusCode) ? new Error(((_b = (_a = e == null ? void 0 : e.response) == null ? void 0 : _a.body) == null ? void 0 : _b.message) || "Bad request") : (debug("Error creating user application from config", e), e);
  }
}
...
async function getInstalledSanityVersion() {
  ...
  if (typeof (pkg == null ? void 0 : pkg.version) != "string")
