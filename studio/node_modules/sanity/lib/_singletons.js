...
}), PortableTextMarkersContext = _createContext.createContext("sanity/_singletons/context/portable-text-markers", []), PortableTextMemberItemElementRefsContext = _createContext.createContext("sanity/_singletons/context/portable-text-member-item-element-refs", new rxjs.BehaviorSubject({})), PortableTextMemberItemsContext = _createContext.createContext("sanity/_singletons/context/portable-text-member-items", []), PresenceContext = _createContext.createContext("sanity/_singletons/context/presence", []), PresenceTrackerContextStore = _createContext.createContext("sanity/_singletons/context/presence-tracker-store", null), PresenceTrackerContextGetSnapshot = _createContext.createContext("sanity/_singletons/context/presence-tracker-get-snapshot", null), PreviewCardContext = _createContext.createContext("sanity/_singletons/context/preview-card", {
  selected: !1
