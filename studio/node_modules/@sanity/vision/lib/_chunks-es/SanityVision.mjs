...
function VisionCodeMirror(props) {
  ...
  let t0;
  return $[0] !== props || $[1] !== theme ? (t0 = /* @__PURE__ */ jsx(EditorRoot, { children: /* @__PURE__ */ jsx(CodeMirror, __spreadValues$5({ basicSetup: !1, theme, extensions: codemirrorExtensions }, props)) }), $[0] = props, $[1] = theme, $[2] = t0) : t0 = $[2], t0;
}
...
function getLocalStorage(namespace) {
  ...
  function merge(props) {
    const state = __spreadValues$4(__spreadValues$4({}, ensureState()), props);
...
function ParamsEditor(props) {
  ...
  let t7;
  return $[16] !== handleChange || $[17] !== t6 ? (t7 = /* @__PURE__ */ jsx(VisionCodeMirror, { value: t6, onChange: handleChange }), $[16] = handleChange, $[17] = t6, $[18] = t7) : t7 = $[18], t7;
}
...
function QueryErrorDetails(t0) {
  ...
  if (!("details" in error))
    return null;
  const details = __spreadValues$3(__spreadValues$3({}, error.details), mapToLegacyDetails(error.details));
  if (!details.line)
    return null;
...
class VisionGui extends PureComponent {
  ...
  handleResize(entries) {
    ...
    this.setState((prevState) => __spreadProps$1(__spreadValues$2({}, prevState), {
...
function VisionContainer(props) {
  ...
  const datasets = t0;
  let t1;
  return $[4] !== datasets || $[5] !== props || $[6] !== t || $[7] !== toast ? (t1 = /* @__PURE__ */ jsx(VisionGui, __spreadProps(__spreadValues$1({}, props), { datasets, toast, t })), $[4] = datasets, $[5] = props, $[6] = t, $[7] = toast, $[8] = t1) : t1 = $[8], t1;
}
...
class VisionErrorBoundary extends Component {
  constructor(props) {
    super(props), __publicField(this, "handleRetryRender", () => this.setState((prev) => ({
      error: null,
...
function SanityVision(props) {
  ...
  let t1;
  $[1] !== props.tool.options ? (t1 = __spreadValues({
    defaultApiVersion: DEFAULT_API_VERSION
  }, props.tool.options), $[1] = props.tool.options, $[2] = t1) : t1 = $[2];
  const config = t1;
  let t2;
