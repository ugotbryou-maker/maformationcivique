...
function createContextClient(config) {
  return restrictClient(
    limitClientConcurrency(
      createClient(__spreadProps$2(__spreadValues$2({}, config), { useCdn: !1, requestTagPrefix: "sanity.migration" }))
    )
  );
}
...
function dryRun(config, migration) {
  return __asyncGenerator$5(this, null, function* () {
    ...
    ), client = createContextClient(__spreadProps$1(__spreadValues$1({}, config.api), { useCdn: !1 })), filteredDocumentsClient = createFilteredDocumentsClient(createReader);
...
var __defProp = Object.defineProperty, __defProps = Object.defineProperties, __getOwnPropDescs = Object.getOwnPropertyDescriptors, __getOwnPropSymbols = Object.getOwnPropertySymbols, __hasOwnProp = Object.prototype.hasOwnProperty, __propIsEnum = Object.prototype.propertyIsEnumerable, __knownSymbol2 = (name, symbol) => (symbol = Symbol[name]) ? symbol : Symbol.for("Symbol." + name), __defNormalProp = (obj, key, value) => key in obj ? __defProp(obj, key, { enumerable: !0, configurable: !0, writable: !0, value }) : obj[key] = value, __spreadValues = (a, b) => {
  for (var prop in b || (b = {}))
...
async function run(config, migration) {
  ...
  const stats = {
    ...
    { signal: abortController.signal }
  ), client = createContextClient(__spreadProps(__spreadValues({}, config.api), {
    useCdn: !1,
    ...
    var _a2;
    stats.currentTransactions = arrify(muts), (_a2 = config.onProgress) == null || _a2.call(config, __spreadProps(__spreadValues({}, stats), {
