  ...
  MetaObject,
  {
    ...
    readonly states: {
      ...
      readonly disconnected: {
        ...
        readonly entry: 'send disconnect'
        readonly on: {
          readonly request: {
            readonly actions: 'create request'
          }
  ...
  MetaObject,
  {
    ...
    readonly states: {
      ...
      readonly handshaking: {
        ...
        readonly entry: 'send handshake syn ack'
        readonly invoke: readonly [
          {
      ...
      readonly connected: {
        readonly entry: readonly ['flush handshake buffer', 'flush buffer']
        readonly invoke: readonly [
          {
            readonly id: 'listen for messages'
            readonly src: 'listen'
