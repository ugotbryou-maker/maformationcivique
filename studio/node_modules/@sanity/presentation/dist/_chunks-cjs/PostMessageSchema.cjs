"use strict";
var reactCompilerRuntime = require("react-compiler-runtime"), ui = require("@sanity/ui"), react = require("react"), index = require("./index.cjs"), sanity = require("sanity"), server = require("react-dom/server"), jsxRuntime = require("react/jsx-runtime"), styledComponents = require("styled-components");
...
const SchemaIcon = function(t0) {
  ...
  const sheet = t1;
  let t2;
  return $[1] !== schemaType.icon || $[2] !== scheme || $[3] !== theme || $[4] !== tone ? (t2 = schemaType.icon ? /* @__PURE__ */ jsxRuntime.jsx(styledComponents.StyleSheetManager, { sheet: sheet.instance, children: /* @__PURE__ */ jsxRuntime.jsx(ui.ThemeProvider, { theme, scheme, tone, children: react.createElement(schemaType.icon) }) }) : null, $[1] = schemaType.icon, $[2] = scheme, $[3] = theme, $[4] = tone, $[5] = t2) : t2 = $[5], t2;
...
function extractSchema(workspace, theme) {
  ...
  function extractIcon(schemaType) {
    if (schemaType.icon)
      return server.renderToString(react.createElement(SchemaIcon, {
        schemaType,
        theme
      }));
  }
...
//# sourceMappingURL=PostMessageSchema.cjs.map
